...
public class PNRStatusActivity extends AppCompatActivity implements WebServicesCallBack,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_chart_prepared.setTypeface(tf);
        tv_boarding_date.setTypeface(tf);
        tv_from_to.setTypeface(tf);
        tv_train_name.setTypeface(tf);
        tv_pnr_number.setTypeface(tf);
        et_pnr_text.setTypeface(tf);
        et_pnr_text.setTypeface(tf);
        et_pnr_text.setTypeface(tf);
        btn_click.setTypeface(tf);
    }
    @Override
